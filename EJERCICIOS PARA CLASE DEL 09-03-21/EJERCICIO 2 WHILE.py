#Escribir un programa que genere aleatoriamente 100 datos y sume todos los números, los negativos, los positivos y calcule el promedio de todos los números, de los positivos y los negatsuma100numeros= 0
